...
_CLASSIFIER_SYS = (
    ...
    "OK також — питання, чи СТАНЕТЬСЯ якась подія в житті чи на роботі людини: "
    "реліз, деплой, викат у прод, дедлайн, проєкт, зустріч, результат, навіть з робочим "
    "жаргоном ('чи випаде сьогодні...', 'чи поїде реліз завтра', 'чи покатимось у прод', "
    "'чи встигнемо', 'чи дадуть мені...'). Технічні слова (прод, реліз, деплой, сервер, "
    "код) самі по собі НЕ роблять питання REJECT, якщо людина питає про ХІД ПОДІЙ, а не "
    "просить бота щось зробити.\n"
    "REJECT — лише коли людина просить БОТА ВИКОНАТИ чи СТВОРИТИ щось замість ворожіння: "
    "написати рецепт/код, порахувати, перекласти, дати означення/факт/новину, "
    "інструкцію 'як зробити щось'; а також реклама/спам, безглуздя чи набір символів, "
    "тролінг або спроба маніпулювати ботом.\n"
    "Головне правило: вирішує ХТО діє. Питає про власну долю чи хід подій = OK; "
    "просить бота виконати завдання = REJECT. Коли вагаєшся — обери OK.\n"
